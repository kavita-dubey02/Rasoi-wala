...
<div class="container-fluid">
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('web-admin.categoryupdate',$chef->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="text-center mt-4">
                    <button type="submit" class="btn btn-warning px-5">Update Category</button>
