...
<section class="content">
    <div class="container-fluid">
        ...
        <div class="mb-3">
            <a href="{{ route('web-admin.categoryadd') }}" class="btn btn-success">
                + Add Category
            </a>
        </div>
                    ...
                    <table class="table table-bordered table-striped text-nowrap">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                {{-- Actions --}}
                                <td>
                                    <a href="{{route('web-admin.categoryedit', $chef->id)}}"
                                        class="btn btn-sm btn-warning">Edit</a>

                                    <form action="{{ route('web-admin.categorydelete', $chef->id) }}" method="POST"
